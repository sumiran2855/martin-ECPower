...
const RegistrationOfVisites: React.FC = () => {
  ...
  const [selectedInstallations, setSelectedInstallations] =useState<InstallationData | null>();
  const [currentPage, setCurrentPage] = useState(1);
  const [itemsPerPage, setItemsPerPage] = useState(10);
  const [paginatedInstallations, setPaginatedInstallations] = useState<
    InstallationData[]
  >([]);
  ...
  return (
    ...
    >
      {!Registration ? (
                  ...
                  >
                    ...
                    <td
                      onClick={() => {
                        ...
                        setSelectedInstallations(paginatedInstallations[index]);
                      }}
        ...
        <RegistrationVisitTest
          onCancel={() => setRegistration(false)}
          Installation={selectedInstallations}
        />
      )}
    </div>
  );
