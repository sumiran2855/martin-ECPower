    ...
    >
      <div className="flex flex-col md:flex-row md:justify-between md:items-center my-4">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-semibold">List of tests</h1>
        </div>
        <div className="flex items-center mt-4 md:mt-0 space-x-2 mr-4">
          <button className="flex items-center text-sm text-blue-500 hover:text-blue-700 transition-colors cursor-pointer">
      ...
      >
        Is the system equipped with any non-standard components, this should be
        registered here
      </p>
      {/* Desktop View */}
